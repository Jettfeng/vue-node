      ...
      <div class="container">
        <div class="checkout-addr">
          ...
          <div class="addr-list-wrap">
            <div class="addr-list">
              <ul>
                <li v-for="(item,index) in addressListFilter" :class="{'check':checkedIndex==index}" @click="checkedIndex=index;selectedAddressId=item.addressId">
                  <dl>
                    <dt>{{item.userName}}</dt>
          ...
          <div class="next-btn-wrap">
            ...
            <router-link :to="{'path':'orderConfirm',query:{addressId:selectedAddressId}}" class="btn btn--m btn--red">
              Next
            </router-link>
          </div>
        </div>
